...
score_forecasts = function(samples_preds, pandemic_periods, suffix='', age_groups,
  ...
  plot_predictions = function(additional_models = c(), horizons = 7 * 1:4){
    ...
    scale_color_discrete(name='Model', labels=labels[sort(c(c(1,5,6), (additional_models-2)))])+
    scale_fill_discrete(name='Model', labels=labels[sort(c(c(1,5,6), (additional_models-2)))])+
